...
Write-Host ""
Write-Host "NOTES:"
Write-Host "  If you want version info in Windows properties (Details tab):"
Write-Host "  - Install gcc/windres (MinGW)"
Write-Host "  - Run: goversioninfo (with proper parameters)"
Write-Host "  - More info: see VERSION_EMBEDDING.md"
Write-Host ""
